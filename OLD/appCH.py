...
class Fonefridge(object):
    def __init__(self, master):
        ...
        # CH
        self.foot_type_current = StringVar()
        self.foot_type_current.set("")
        ...
        self.food_type_dropdown = Combobox(self.frame_vars, value=self.food_type_list, 
                                            textvariable=self.foot_type_current,
                                            state='readonly')
        ...
        # CH
        self.foot_name_current = StringVar()
        self.foot_name_current.set("")
        ...
        self.food_names_dropdown = Combobox(self.frame_vars, value=[""],
                                            textvariable=self.foot_name_current,
                                            state='readonly')
        ...
        self.servings_current = StringVar()
        self.servings_current.set("")
        ...
        self.servings_dropdown = Combobox(self.frame_vars, value=self.servings_list,
                                            textvariable=self.servings_current,
                                            state='readonly')
        self.servings_dropdown.place(relx=0.8, rely=0.3, relwidth=0.27, anchor="n")
        

        #PREVIEW BUTTON:
        self.preview_button = Button(self.frame_vars, text="PREVIEW SELECTED ITEM", 
                                    command=self.show_the_item)
    ...
    def show_the_item(self):
        ...
        # CH  check if we have 3 valid values
        ft = self.foot_type_current.get()
        fi = self.foot_name_current.get()
        sv = self.servings_current.get()
        if ft != "" and fi  != "" and sv != "":
    ...
    def notification_trigger(self): #================NOTIFICATION PROBLEM HERE==============================
